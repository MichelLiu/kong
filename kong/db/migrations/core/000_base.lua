  ...
  mysql = {
    up = [[
      ...
      CREATE TABLE IF NOT EXISTS routes (
        ...
        created_at     timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        updated_at     timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        protocols      varchar(255) DEFAULT '[]',
        methods        varchar(255) DEFAULT '[]',
        hosts          varchar(255) DEFAULT '[]',
        ...
        name           text,
        snis           varchar(255) DEFAULT '[]',
        sources        varchar(255) DEFAULT '[]',
        destinations   varchar(255) DEFAULT '[]',
      ...
      CREATE TABLE IF NOT EXISTS plugins(
        ...
        UNIQUE KEY plugins_cache_key(cache_key),
        ...
        INDEX plugins_run_on_idx(run_on)
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
      ...
      CREATE TABLE IF NOT EXISTS targets(
        ...
        INDEX targets_upstream_id_idx(upstream_id)
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
      ...
      CREATE TABLE IF NOT EXISTS websites (
        ...
        locations        text,
        UNIQUE KEY website_unique(name,listen)
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
